...
![App con datos validados](screenshots/datos-cargados.png)

Captura de pantalla de codigo html con pipes standards y personalizado:
![App con errores de validacion](screenshots/pipes-cargados.png)

Captura de pantalla con los productos cargados:
![App con datos en console log](screenshots/producto-cargado.png)

Captura de pantalla con un producto eliminado:
![App con datos en console log](screenshots/producto-eliminado.png)
